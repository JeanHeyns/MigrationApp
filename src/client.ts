  ...
  commondataserviceforapps: {
    ...
    apis: {
      ...
      GetEntityAttributeByMetadataIdCast: {
        path: "/{connectionId}/api/data/v9.1.0/EntityDefinitions(LogicalName='{entityLogicalName}')/Attributes({attributeMetadataId})/{attributeCast}",
        method: 'GET',
        parameters: [
          { name: 'connectionId',    in: 'path',   required: true,  type: 'string' },
          { name: 'organization',    in: 'header', required: true,  type: 'string' },
          { name: 'accept',          in: 'header', required: true,  type: 'string' },
          { name: 'entityLogicalName', in: 'path', required: true,  type: 'string' },
          { name: 'attributeMetadataId', in: 'path', required: true, type: 'string' },
          { name: 'attributeCast',   in: 'path',   required: true,  type: 'string' },
          { name: '$select',         in: 'query',  required: false, type: 'string' },
          { name: '$expand',         in: 'query',  required: false, type: 'string' },
        ],
      ...
      GetEntityAttributeByLogicalNameCast: {
        path: "/{connectionId}/api/data/v9.2/EntityDefinitions(LogicalName='{entityLogicalName}')/Attributes(LogicalName='{attributeLogicalName}')/{attributeCast}",
        method: 'GET',
        parameters: [
          { name: 'connectionId',    in: 'path',   required: true,  type: 'string' },
          { name: 'organization',    in: 'header', required: true,  type: 'string' },
          { name: 'accept',          in: 'header', required: true,  type: 'string' },
          { name: 'entityLogicalName', in: 'path', required: true,  type: 'string' },
          { name: 'attributeLogicalName', in: 'path', required: true, type: 'string' },
          { name: 'attributeCast',   in: 'path',   required: true,  type: 'string' },
          { name: '$select',         in: 'query',  required: false, type: 'string' },
          { name: '$expand',         in: 'query',  required: false, type: 'string' },
        ],
      ...
      GetPicklistAttribute: {
        path: "/{connectionId}/api/data/v9.2/EntityDefinitions(LogicalName='{entityLogicalName}')/Attributes(LogicalName='{attributeLogicalName}')/Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
        method: 'GET',
        parameters: [
          { name: 'connectionId',    in: 'path',   required: true,  type: 'string' },
          { name: 'organization',    in: 'header', required: true,  type: 'string' },
      ...
      GetMultiSelectPicklistAttribute: {
        path: "/{connectionId}/api/data/v9.2/EntityDefinitions(LogicalName='{entityLogicalName}')/Attributes(LogicalName='{attributeLogicalName}')/Microsoft.Dynamics.CRM.MultiSelectPicklistAttributeMetadata",
        method: 'GET',
        parameters: [
          { name: 'connectionId',    in: 'path',   required: true,  type: 'string' },
          { name: 'organization',    in: 'header', required: true,  type: 'string' },
